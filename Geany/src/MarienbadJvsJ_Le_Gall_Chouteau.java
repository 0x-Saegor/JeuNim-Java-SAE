 ...
 */
class MarienbadJvsJ_Le_Gall_Chouteau {
     ...
     */
    void testCasVerifLigne(int[] tab, int ligne, boolean result) {
        // Affichage
     ...
     * @param result : resultat attendu
     */
    void testCasVerifAllumettes(int[] tab, int ligne, int nbAllumettes, boolean result) {
        // Affichage
