 ...
 */
class MarienbadJvsO_Le_Gall_Chouteau {
     ...
     * Un tour de jeu
     */
    void jouer(String joueur, int[] allumettes, int level) {
        clearScreen();
     ...
     */
    boolean verifLigne(int ligne, int[] tab) {
     ...
     */
    void testCasVerifLigne(int[] allumettes, int ligne, boolean result) {
        // Affichage
     ...
     * @return nimsum valeur de la NimSum
     */
    boolean verifAllumettes(int ligne, int nbAllumettes, int[] tab) {
     ...
     * @param result : resultat attendu
     */
    void testCasVerifAllumettes(int[] allumettes, int ligne, int nbAllumettes, boolean result) {
        // Affichage
     ...
     */
    boolean verifWin(int[] allumettes) {
        boolean win = true;
     ...
     * @param result : resultat attendu
     */
    void testCasVerifWin(int[] allumettes, boolean result) {
        // Affichage
     ...
     * @param result : resultat attendu
     */
    void testCasCalcNimSum(int[] allumettes, int result) {
        // Affichage
